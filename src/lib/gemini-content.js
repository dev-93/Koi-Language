...
중요:
1. 이전에 자주 나온 "카페", "벚꽃", "첫 데이트", "이자카야" 같은 뻔한 상황은 피하세요.
2. 구체적이고 생생한 상황을 만드세요 (예: "비 오는 날 편의점 앞에서 우산 나눠쓰기", "온천 여관에서 유카타 입고 불꽃놀이 보기", "공원 벤치에서 도시락 나눠 먹기").
3. 매번 다른 카테고리를 선택하세요. 같은 카테고리가 연속으로 나오면 안 됩니다.
4. 표현은 최소 3개, 최대 6개로 상황의 복잡도에 따라 자유롭게 조절하세요.
5. 모든 reading_en 필드에는 영어 로마자 발음(Romaji)을 적으세요.
6. 각 표현의 words는 핵심 단어 최대 3개만 포함하세요.`;

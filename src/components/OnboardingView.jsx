                        ...
                        <button
                            ...
                            className={`onboarding-btn-option border-none cursor-pointer d-flex items-center justify-center gap-3 transition-all ${
                                formData.nationality === 'KR'
                                    ? 'bg-peach text-white shadow-lg scale-105'
                ...
                {step === 3 && (
                    <div className="w-full d-flex gap-4 mt-12 animate-in fade-in zoom-in-95 duration-500">
                        ...
                        >
                            <User
                                size={32}
                                className={`${formData.gender === 'M' ? 'text-blue-400' : 'text-gray-300'}`}
                                fill={formData.gender === 'M' ? '#60a5fa' : 'none'}
                            />
                        ...
                        >
                            <User
                                size={32}
                                className={`${formData.gender === 'F' ? 'text-pink-400' : 'text-gray-300'}`}
                                fill={formData.gender === 'F' ? '#f472b6' : 'none'}
                            />

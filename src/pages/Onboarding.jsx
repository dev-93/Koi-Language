...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 overflow-hidden" style={{ background: 'var(--bg-gradient)' }}>
      <header className="mb-12 text-center">
        ...
        <p className="text-sm font-bold text-gray-400 mt-2 uppercase tracking-widest">Connect through language</p>
      </header>
      ...
      <div className="w-full max-w-[360px] relative min-h-[400px]">
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <div className="text-center">
                <h2 className="m-0 text-2xl font-black text-gray-800 mb-1">반가워요!</h2>
                <p className="m-0 text-sm text-gray-400 font-bold">당신은 누구인가요?</p>
              </div>
              ...
              <button className="flex items-center gap-2 mt-4 text-pink-500 font-black text-lg border-none bg-transparent active:scale-95 transition-all" onClick={nextStep}>
          ...
          {step === 2 && (
            ...
            >
              <div className="text-center">
                <h2 className="m-0 text-2xl font-black text-gray-800 mb-1">성별이 무엇인가요?</h2>
                <p className="m-0 text-sm text-gray-400 font-bold">맞춤형 대화법을 제안할게요</p>
              </div>
              ...
              <div className="flex justify-between w-full mt-4">
                 <button className="flex items-center gap-1 text-gray-400 font-bold border-none bg-transparent" onClick={prevStep}>
                   <ChevronLeft size={18}/> 이전
                 </button>
                 <button className="flex items-center gap-1 text-pink-500 font-black text-lg border-none bg-transparent" onClick={nextStep}>
          ...
          {step === 3 && (
            ...
            >
              <div className="text-center">
                <h2 className="m-0 text-2xl font-black text-gray-800 mb-1">어떤 상대와 대화하나요?</h2>
                <p className="m-0 text-sm text-gray-400 font-bold">설레는 첫 대화를 준비해봐요</p>
              </div>
              ...
              <div className="flex flex-col gap-4 w-full mt-4">
                 ...
                 <button className="flex items-center justify-center gap-1 text-gray-400 font-bold border-none bg-transparent" onClick={prevStep}>
                   이전으로
                 </button>
              </div>
            </motion.div>
      ...
      <div className="flex gap-2.5 mt-10">
        {[1, 2, 3].map(i => (
          <div key={i} className={`h-2.5 rounded-full transition-all duration-300 ${step === i ? 'w-10 bg-pink-500 shadow-[0_0_8px_rgba(255,138,138,0.4)]' : 'w-2.5 bg-gray-200'}`} />
        ))}
      </div>
    </div>
  );

            ...
            <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-4">
                {messages.map((msg, idx) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`shadow-sm ${isUser ? 'chat-bubble user bg-[#FF8A8A]' : 'chat-bubble ai bg-white border border-pink-50'}`}
                                style={{
                                    borderRadius: isUser
                                        ? '24px 24px 4px 24px'
                                        : '24px 24px 24px 4px',
                            ...
                            >
                                ...
                                {tipText && (
                                    <div
                                        className={`mt-3 pt-3 border-t text-[12px] font-bold leading-relaxed ${isUser ? 'border-white/20 text-white/80' : 'border-gray-100 text-[#FF8A8A]'}`}
                                    >
                                        {tipText}
                                    </div>
                                )}
